---
layout: default
title: Flight Operations (Community)
nav_exclude: true
---
...
## What happens if I change aircraft mid-flight?
...
| Cause | Fix |
|-------|-----|
| FS not connected | Start your simulator; wait for the green connection indicator |
