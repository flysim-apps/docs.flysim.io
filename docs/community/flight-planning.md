---
layout: default
title: Flight Planning (Community)
nav_exclude: true
---
...
{: .note }
If the button is greyed out, check your FS connection status.
...
FlyAround's built-in flight planner automatically builds your full flight plan:
...
- Make sure your aircraft is loaded in your simulator **before** confirming the flight — tracking will start immediately.
